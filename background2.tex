...
A \textit{path} is a sequence of vertices $v_1,v_2,\dotsc,v_k$ such that for
...
A \textit{rooted tree} (or \textit{oriented tree}) is a directed graph $(V,E)$
