...
phylogenetics.  Figure~\ref{fig:example-equidistant} shows an example of a
tree with an equidistant edge-weighting using two common display formats.
...
\begin{figure}
  \centering
  \input{figures/background2/build-ex.pdft}
