  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \begin{tikzpicture}
      \begin{axis}[width=1.2\textwidth,xmin=30,xmax=270,ymin=80,ymax=270,ticks=none]
        ...
        \addplot[only marks,color=red,mark=+] table {figures/chaining-dissection/chaining2};
      \end{axis}
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \begin{tikzpicture}
      \begin{axis}[width=1.2\textwidth,xmin=90,xmax=230,ymin=230,ymax=400,ticks=none]
        ...
        \addplot[only marks,color=red,mark=+] table {figures/chaining-dissection/dissection2};
      \end{axis}
    \end{tikzpicture}
