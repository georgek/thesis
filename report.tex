...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{The Haussdorf distance between two subsets of a metric space is,
    informally, the greatest distance one must travel if starting from a point
    in one set and travelling to the closest point in the other set.  This
    distance is marked in the diagram.}
  \label{fig:haussdorf}
\end{figure}
