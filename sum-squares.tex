...
metric space and compare their performance.  This chapter is based on the
following paper:
...
Our second criterion for homogeneity we call the \textit{centroid-distance
  cost}:
\begin{equation}
  \label{eq:CDC}
...
The mutual information between two clusterings, $\clus_1 =
