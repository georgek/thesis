...
Contributions by the author include: the examples showing that
...
Theorem~\ref{thm:worst-case}.  The author was also responsible for preparation
of the published manuscript and implementation of the assignment metric for
testing.
