...
\textit{\sffamily This chapter is largely based on the following paper:}
\vspace{0.5em}
...
\end{equation*}
This bound is tight and can be met with the worst case which is illustrated in
Figure~\ref{fig:worst-case}:
\begin{align*}
  ...
  &\{k,k+k,\dotsc,(k-1)k+k\}\}.
\end{align*}
This also produces the worst case under the VI metric, as shown in
\citep{meila-2007}.
